...
const Header = ({isAuthenticated= false,user}) => {
  ...
  return <>
  <ColorModeSwitcher/>
  <Button zIndex={"overlay"} onClick={onOpen} colorScheme={"purple"} width="12" height={'12' }rounded="full" position={"fixed"}
  top="6" left={"6"}>
    <RiMenu5Fill/>
  </Button>
...
<DrawerContent>
    ...
    <DrawerHeader borderBottom={'1px'}>MY Course</DrawerHeader>
    <DrawerBody>
        <VStack spacing={"4"} alignItems={"flex-start"}>
           <LinkButton onClose={onClose} url="/" title="Home"/>
           <LinkButton onClose={onClose} url="/courses" title="All Course"/>
           ...
           >
            {
                ...
                <VStack>
                    ...
                    {user && user.role ==='admin' &&(
                        ...
                        <Button colorScheme='purple' > <RiDashboardFill/>Dashboard</Button>
                        </Link>
                    )
